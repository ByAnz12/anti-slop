...
- is added at the end of the entry file on a first install, and replaced in place on later runs. Nothing else in the file is touched: your prose, blank lines, code blocks, and line endings are left as they are, and the only lines it ever removes are antislop's own marker comments.
